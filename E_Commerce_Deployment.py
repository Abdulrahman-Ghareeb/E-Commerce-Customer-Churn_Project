...
model = joblib.load(r'E:\Abdulrahman\مبادرة رواد مصر الرقمية\Project\model.pkl')
scaler = joblib.load(r'E:\Abdulrahman\مبادرة رواد مصر الرقمية\Project\scaler.pkl')
encoder = joblib.load(r'E:\Abdulrahman\مبادرة رواد مصر الرقمية\Project\encoder.pkl')
category_means = joblib.load(r'E:\Abdulrahman\مبادرة رواد مصر الرقمية\Project\category_means.pkl')
train_columns = joblib.load(r"E:\Abdulrahman\مبادرة رواد مصر الرقمية\Project\train_columns.pkl")
